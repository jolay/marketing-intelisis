...
jQuery(document).ready(function() {
    ...
    jQuery('.tw-chart-graph').each(function(){
        ...
        jQuery('>ul.data>li',$curr).each(function(){
            ...
            if($currData.attr('data-fill-text')&&$currData.attr('data-fill-color')){$listDesc+='<li><i class="fa fa-stop" style="color:'+$currData.attr('data-fill-color')+';"></i>'+$currData.attr('data-fill-text')+'</li>';}
            $datasets.push(
                {
                    // Line And Radar
    ...
    jQuery('.tw-chart-pie').each(function(){
        ...
        jQuery('>ul.data>li',$curr).each(function(){
            ...
            if($currData.attr('data-fill-text')&&$currData.attr('data-value')&&$curr.attr('data-labellist')==='true'){
                $listDesc+='<li><i class="fa fa-stop" style="color:'+$currData.attr('data-color')+';"></i>'+$currData.attr('data-fill-text')+'<span>('+$currData.attr('data-value')+')</span></li>';
            }
            $data.push(
                {
                    //Polar Area
